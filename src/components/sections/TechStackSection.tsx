      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-cool-gray max-w-4xl mx-auto leading-relaxed">
            ...
            , and{" "}
            <span className="text-brand-teal font-semibold">databases</span> to
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-20 bg-gradient-to-r from-slate-blue to-transparent z-10 pointer-events-none"></div>
          <div className="absolute right-0 top-0 bottom-0 w-20 bg-gradient-to-l from-slate-blue to-transparent z-10 pointer-events-none"></div>
